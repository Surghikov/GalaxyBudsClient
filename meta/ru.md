...
<tr><td>58%</td><td>235 missing string(s)</td></tr>
</table>
...
<tr><td><code>last_updated_at_n</code></td><td>Последнее обновление: {0}</td></tr>
<tr><td><code>file_not_found</code></td><td>Файл не найден</td></tr>
<tr><td><code>feature_unsupported_platform</code></td><td>В настоящее время эта функция не поддерживается на этой платформе.</td></tr>
...
<tr><td><code>touchoption_custom_trigger_event</code></td><td>Активируем действие наушника...</td></tr>
<tr><td><code>hotkey_add_short</code></td><td>Новый</td></tr>
<tr><td><code>hotkey_edit_long</code></td><td>Изменить горячую клавишу</td></tr>
<tr><td><code>event_nc_switch_one</code></td><td>Шумоподавление с одним наушником</td></tr>
<tr><td><code>welcome_register</code></td><td>Настройте свои наушники</td></tr>
<tr><td><code>welcome_register_desc</code></td><td>Выберите и зарегистрируйте свои наушники Galaxy Buds</td></tr>
<tr><td><code>welcome_android_hint_title</code></td><td>Важная информация для пользователей Android</td></tr>
<tr><td><code>welcome_android_hint</code></td><td>Это приложение изначально было разработано для использования на настольных компьютерах. Функции, которым требуется, чтобы это приложение работало в фоновом режиме, такие как пользовательские сенсорные действия и статистика использования аккуиулятора, в настоящее время недоступны в этой версии.
Если официальное приложение Samsung Wearable активно вместе с этим приложением, могут возникнуть проблемы с подключением. Пожалуйста, убедитесь, что вы правильно закрыли официальное приложение перед использованием этого приложения.</td></tr>
<tr><td><code>mainpage_header</code></td><td>Домой</td></tr>
<tr><td><code>mainpage_fit_test</code></td><td>Проверка положения наушников</td></tr>
<tr><td><code>devsel_manual_pair_title</code></td><td>Вашего устройства нет в списке?</td></tr>
<tr><td><code>devsel_manual_pair_description</code></td><td>Убедитесь, что ваши наушники уже сопряжены. Если они все еще не распознаются, попробуйте использовать опцию ручного подключения.</td></tr>
<tr><td><code>devsel_manual_pair</code></td><td>Ручное подключение</td></tr>
...
<tr><td><code>hidden_mode_serial_change</code></td><td>Изменить серийный номер</td></tr>
...
<tr><td><code>batt_hist_tools_measure_battery</code></td><td>Уровень измерения</td></tr>
...
<tr><td><code>adv_pause_playback</code></td><td>Остановить воспроизведение, если вы сняли наушники</td></tr>
...
<tr><td><code>rename_warn_oneui_title</code></td><td>Важная информация для пользователей OneUI</td></tr>
